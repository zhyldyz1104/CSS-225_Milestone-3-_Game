...
- chapter4.py – Learn spiritual lessons, solve riddles, and reach the pyramids—or restart the game if you fail.
🕹️ How to Play
Run main.py to start the game. You’ll be asked whether you want to begin each chapter. Your choices will shape Santiago’s path. If you fail to solve the riddles in Chapter 4, the game restarts from Chapter 1.
🛠 Features
- Modular design using separate .py files for each chapter
- Interactive choices using input()
- Conditional logic and branching paths
- Replayable ending with restart option
